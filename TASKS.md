...
- **2026-08-19 — `X-OFI-HORSERACE-DAT20-05`: the seven-family causal-alignment horse race has no
  ...
  excluded rather than assigned a false sign. M6 leads reproducibly at 0.5–2 s, M4 at 5 s and raw
  ...
  `docs/OFI-HORSERACE-2026-08-19.md`; compact hashes/results under `docs/results/`.
